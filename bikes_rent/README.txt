...
2. Transform the data and count the number of trips per day. Visualize the result
3. Use the daily aggregated data and calculate a moving average with a window of 3
4. Calculate the difference between the observed values and the values calculated using the moving average
